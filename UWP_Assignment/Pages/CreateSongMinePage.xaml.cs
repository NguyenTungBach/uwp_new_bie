...
namespace UWP_Assignment.Pages
{
    ...
    /// </summary>
    public sealed partial class CreateSongMinePage : Windows.UI.Xaml.Controls.Page
    {
        private static string publicIDCloudinary;
        private CloudinaryDotNet.Account accountCloudinary;
        private Cloudinary cloudinary;
        private int checkValid = 0;
        public CreateSongMinePage()
        {
            this.InitializeComponent();
            Loaded += CreateSongMinePage_Loaded;
        }

        private void CreateSongMinePage_Loaded(object sender, RoutedEventArgs e)
        {
